...
| 04-12 T3 | 12 | 1 | CORRECT-01..08, CALC-01, CALC-02, DIARY-01 (unblocks) | — | Entry-point reachability: a real pipeline run emits a `crc:` keyboard the dispatcher can receive | unit | `npx vitest run src/bot/entry-point-reachability.test.ts && npm test && npx tsc --noEmit` | created by 04-12 T3 | ⬜ pending |
