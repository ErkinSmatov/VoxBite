...
Plans:
**Wave 1**
- [x] 04.1-01-PLAN.md — Mini App toolchain: vetted deps, api/ wired into test+typecheck, Vite/Vercel scaffold
...
- [x] 04.1-04-PLAN.md — GET draft + confirm endpoints
- [x] 04.1-05-PLAN.md — swap-candidate / adjust-grams / typed-grams endpoints (+ recompute guard)
- [x] 04.1-06-PLAN.md — remove-component / add-component endpoints (+ per-container matching deps)
...
- [x] 04.1-10-PLAN.md — Mini App totals, add-component, empty state, confirm/save/delete footer
- [x] 04.1-11-PLAN.md — Delete the chat correction UI and the awaiting_input call sites

**Wave 6** *(blocked on Wave 5)*
- [x] 04.1-12-PLAN.md — [BLOCKING] drop the awaiting_input column via generate + owner-reviewed migrate

**Wave 7** *(blocked on Wave 6)*
- [x] 04.1-13-PLAN.md — Deploy to Vercel, register the domain with BotFather, live auth smoke tests
...
| 04.1. Telegram Mini App correction UI | 13/14 | In Progress|  |
